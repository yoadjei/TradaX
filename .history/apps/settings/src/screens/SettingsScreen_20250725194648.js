...
export default function SettingsScreen() {
  ...
  const [security, dispatchSecurity] = useReducer(
    securityReducer,
    securityInitial
  );
  ...
  useEffect(() => {
    (async () => {
      ...
      if (prefs?.notifications) {
        dispatchNotifications({ type: 'SET', payload: prefs.notifications });
      }
      if (prefs?.security) {
        dispatchSecurity({ type: 'SET', payload: prefs.security });
      }
    })();
  }, []);
          ...
          <SettingsRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={() => dispatchNotifications({ type: 'TOGGLE', key: 'priceAlerts' })}
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
          ...
          <SettingsRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={() => dispatchNotifications({ type: 'TOGGLE', key: 'newsUpdates' })}
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
          ...
          <SettingsRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={() => dispatchNotifications({ type: 'TOGGLE', key: 'tradingUpdates' })}
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
          ...
          <SettingsRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={() => dispatchNotifications({ type: 'TOGGLE', key: 'securityAlerts' })}
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
          ...
          <SettingsRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={() => dispatchSecurity({ type: 'TOGGLE', key: 'twoFactorEnabled' })}
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
          ...
          <SettingsRow
            ...
            rightComponent={
              <Switch
                ...
                onValueChange={() => dispatchSecurity({ type: 'TOGGLE', key: 'biometricEnabled' })}
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
