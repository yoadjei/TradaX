// wallet/src/stores/WalletContext.js
...
const WalletContext = createContext(defaultCtx);
...
export function useWallet() {
  return useContext(WalletContext) || defaultCtx;
}

export const withWalletProvider = (Component) => (props) => (
  <WalletProvider>
    <Component {...props} />
  </WalletProvider>
);
