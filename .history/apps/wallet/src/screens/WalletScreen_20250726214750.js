...
export default function WalletScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      {/* SEARCH MODAL — shows empty state until user types */}
      <Modal
        ...
        <SafeAreaView style={[styles.searchModalContainer, { backgroundColor: theme.colors.background }]}>
          ...
          >
            <View style={[styles.searchBarWrap, { borderBottomColor: theme.colors.border }]}>
              ...
              />
              <Pressable onPress={() => { setSearchModalVisible(false); setShowSearchBar(false); setSearch(''); }} style={styles.searchCancelBtn}>
