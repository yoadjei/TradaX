...
public class WalletService {
    ...
    public Transaction deposit(String userEmail, String asset, BigDecimal amount) {
        ...
        transaction.setPrice(getCurrentPrice(asset.toLowerCase()));
        transaction.setValue(amount.multiply(getCurrentPrice(asset.toLowerCase())));
    ...
    public Map<String, Object> getPortfolioPerformance(String userEmail) {
        ...
        BigDecimal gainPercentage = gain.divide(initialValue, 4, RoundingMode.HALF_UP).multiply(new BigDecimal("100"));
        
        performance.put("totalValue", totalValue);
        performance.put("initialValue", initialValue);
        performance.put("totalGain", gain);
        performance.put("totalGainPercentage", gainPercentage);
