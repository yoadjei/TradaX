...
const AUTH_SERVICE_URL = Constants.expoConfig?.extra?.authServiceUrl || 'http://localhost:8081';
const WALLET_SERVICE_URL = Constants.expoConfig?.extra?.walletServiceUrl || 'http://localhost:8082';
